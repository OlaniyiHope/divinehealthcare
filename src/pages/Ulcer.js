...
const Ulcer = () => {
  ...
  useEffect(() => {
    const fetchFibroidDescription = async () => {
      try {
        const response = await fetch(`${apiUrl}/api/divine/get-ulcer`);
              ...
              <div class="row justify-content-center">
                <div class="col-xl-10">
                  <div class="breadcrumb-content text-center">
                    <h2 class="title">Treatments for Ulcer</h2>
                          ...
                          <div id="package" class="woocommerce-package">
                            <div id="comments">
                              ...
                              <p>
                                ...
                                depends on the level of severity of your Ulcer
                                <br></br>
                                ...
                                This treatment is for those that think it is
                                finished after they discovered they Ulcer. don't
                                lose hope.<br></br>
