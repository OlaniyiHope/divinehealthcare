                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb">
                      ...
                      <span property="itemListElement" typeof="ListItem">
                        <a
                          property="item"
                          typeof="WebPage"
                          title="Go to the Nutrition Category archives."
                          href="../../product-category/nutrition/index.html"
                          class="taxonomy product_cat"
                        >
                ...
                <div class="col-lg-6">
                  <div class="summary entry-summary inner-shop-details-content">
                    ...
                    >
                      ...
                      <i class="fas fa-star"></i>
                      <i class="fas fa-star"></i>
                      <span class="rating-count">( 5.00 out of 5 )</span>
                    </div>
                    <h1 class="product_title title entry-title">
                      Optimum Nutrition
                    </h1>
                    ...
                    <div class="inner-shop-details-bottom">
                      <div class="sku_wrapper">
                        <b>SKU :</b> <span class="sku">QZX8VG-T5</span>
                      </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="woocommerce-tabs wc-tabs-wrapper product-desc-wrap">
                    <ul
                      class="tabs wc-tabs nav list-wrap nav-tabs"
                      role="tablist"
                    >
                      <li
                        class="description_tab nav-item"
                                ...
                                <div class="comment-text">
                                  ...
                                  <div class="description">
                                    <p>
                                      ...
                                      consequat. Enim ad minim veniam, quis
